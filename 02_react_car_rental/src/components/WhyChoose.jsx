    ...
    <section id='whychoose'>
      <div className='container-fluid'>
        <div className='text-center'>
          <h2 className='blue-h'>why choose us</h2>
        </div>
        <div className='row pt-4'>
          ...
          <div className='col-lg-6 order-lg-2 order-1 px-3 d-flex justify-content-center'>
            <div>
              <h3 className='sub-h mb-3'>
                We offer the best experience <br /> with our rental deals
              </h3>
              {causesToChoose.map((cause, inx) => (
